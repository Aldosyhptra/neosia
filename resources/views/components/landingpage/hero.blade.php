    ...
    <div class="w-full h-full 2xl:h-screen relative py-25 md:pt-30 lg:pt-50">
        ...
        <div class="absolute inset-0 z-0">
            <div class="swiper bgSwiper w-full h-full relative">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" data-title="PROFESSIONAL COURSES">
                        <img src="/img/hero2.jpg" class="w-full h-full object-cover" />
                    </div>
                    <div class="swiper-slide" data-title="GLOBAL CERTIFICATION">
                        <img src="/img/hero3.jpg" class="w-full h-full object-cover" />
                    </div>
                    <div class="swiper-slide" data-title="SOFTWARE LICENSE">
                        <img src="/img/hero4.jpg" class="w-full h-full object-cover" />
                    </div>
                    <div class="swiper-slide" data-title="COMMUNITY EVENTS">
                        <img src="/img/hero5.jpg" class="w-full h-full object-cover" />
                    </div>
                </div>
        ...
        <div id="slide-contents" class="relative z-20 flex flex-col justify-start h-full px-3 md:px-10"
            ...
            <div class="slide-content text-white px-10 md:px-15" data-title="HOME">
                <h1 class="text-center xl:text-start text-3xl md:text-5xl font-bold mb-7">
                    UNLOCK YOUR POTENTIAL <br>
                    <span class="text-[#FFB71A]">WITH NEOSIA TRAINING CENTER</span>
                </h1>
                <p class="text-center xl:text-start text-sm md:text-base max-w-2xl">
            ...
            <div class="slide-content text-white px-10 md:px-15" data-title="GLOBAL CERTIFICATION">
                <div class="flex flex-col lg:flex-row justify-between gap-5">
                    ...
                    <img src="/img/landingpage/standglobal.png" alt=""
                        class="min-w-70 max-w-1/3 mx-auto xl:mx-0 select-none" draggable="false">
                </div>
                <a href="/about"
                    class="2xl:absolute 2xl:bottom-1/4 w-fit text-start px-5 py-2 flex justify-center lg:justify-start mx-auto lg:mx-0  rounded-2xl bg-[#FFB71A] max-w-40 text-sm text-black font-semibold  mt-10   hover:bg-[#ff8b10] hover:text-white transition-all">
                    About Us
            ...
            {{-- desktop --}}
            <div class="2xl:flex flex-wrap hidden mx-auto absolute -bottom-5 left-0 right-0 justify-center z-10">
                ...
                <div class="relative flex items-center w-70">
                    ...
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="PROFESSIONAL COURSES">PROFESSIONAL COURSES</p>
                </div>
                <div class="relative flex items-center w-70">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="GLOBAL CERTIFICATION">GLOBAL CERTIFICATION</p>
                </div>
                <div class="relative flex items-center w-70">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="SOFTWARE LICENSE">SOFTWARE LICENSE</p>
                </div>
                <div class="relative flex items-center w-70">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="COMMUNITY EVENTS">COMMUNITY EVENTS</p>
            ...
            <div class="hidden md:block 2xl:hidden">
                <div class="md:flex flex-row mt-20 justify-center">
                    <div class="relative flex items-center w-70">
                        <div class="absolute left-0 bg-[#FFB71A] w-[3px] rounded h-25"></div>
                        <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5" data-title="HOME">
                            HOME
                        </p>
                    </div>
                    <div class="relative flex items-center w-70">
                ...
                slideChange: function() {
                    ...
                    document.querySelectorAll('.menu-label').forEach(el => {
                        if (el.getAttribute('data-title') === title) {
                            ...
                            el.classList.add('text-[#FFB71A]');
                        } else {
                            el.classList.add('text-white');
                            el.classList.remove('text-[#FFB71A]');
                        }
                    });
                }
            }
