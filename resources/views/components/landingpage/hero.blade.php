<section>
    <div class="w-full h-full xl:h-screen relative py-25 md:pt-30 lg:pt-50">
        <!-- Swiper Container -->
        ...
        <div id="slide-contents" class="relative z-20 flex flex-col justify-start h-full px-3 md:px-10"
            ...
            {{-- desktop --}}
            <div class="xl:flex flex-wrap hidden mx-auto absolute -bottom-15 left-0 right-0 justify-center z-10">
                ...
                <div class="relative flex items-center w-60">
                    ...
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="PROFESSIONAL COURSES">PROFESSIONAL <br> COURSES</p>
                </div>
                <div class="relative flex items-center w-60">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="GLOBAL CERTIFICATION">GLOBAL <br> CERTIFICATION</p>
                </div>
                <div class="relative flex items-center w-60">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="SOFTWARE LICENSE">SOFTWARE <br> LICENSE</p>
                </div>
                <div class="relative flex items-center w-60">
                    <div class="absolute left-0 bg-gray-200 w-[3px] rounded h-25"></div>
                    <p class="menu-label mx-auto text-sm md:text-base text-white px-2 md:px-5"
                        data-title="COMMUNITY EVENTS">COMMUNITY <br> EVENTS</p>
