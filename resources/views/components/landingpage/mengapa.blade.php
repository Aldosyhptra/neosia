<section>
    <div class="w-full flex flex-col lg:flex-row justify-between items-center gap-5 py-10 px-3 pb-25">
        <div class="relative">
            ...
            <img src="/img/landingpage/mengapa.jpg" 
                alt=""
                class="relative z-10 rounded md:ml-20 md:mr-10 max-w-[300px] sm:max-w-[400px] md:max-w-[600px] lg:max-w-[500px] xl:max-w-[800px]">
            <img src="/img/landingpage/neosiaTraining.png" 
                alt=""
        ...
        <div class="px-3 md:px-5">
            ...
            <a href="" class="text-xs text-black py-2 px-4 rounded-2xl bg-[#FFB71A] font-semibold flex mx-auto lg:mx-0  w-fit mt-7 hover:bg-[#ff8b10] hover:text-white transition-all">View All Course</a>
        </div>
    </div>
</section>