<nav class="w-full">
        <div class="bg-black flex flex-row justify-between items-center p-4 md:px-5 lg:px-10">
            ...
            <div class="flex flex-col md:flex-row gap-3">
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open"
                        ...
                        <ul class="py-1">
                            <li>
                                <a href="#category1" class="block px-4 py-2 hover:bg-gray-100">Category 1</a>
                            </li>
                            <li>
                                <a href="#category2" class="block px-4 py-2 hover:bg-gray-100">Category 2</a>
                            </li>
                            <li>
                                <a href="#category3" class="block px-4 py-2 hover:bg-gray-100">Category 3</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <label for="Search">
                    <div class="relative">
                        ...
                        class="mt-0.5 text bg-white w-full rounded border-gray-300 p-2 pe-10 shadow-sm text-xs md:text-sm "
                        />
        ...
        <div class="bg-[#1B1C1E] text-sm p-4 md:px-5 lg:px-10 flex flex-col lg:flex-row justify-between md:items-start lg:items-center gap-5">
            <div class="flex flex-col flex-wrap md:flex-row gap-4 lg:gap-10 ">
                ...
                >
                    ...
                    <div
                        x-show="open || hover"
                        x-transition
                        class="absolute left-0 mt-0.5 w-48 bg-white border rounded-lg shadow-lg z-50"
                    >
                        <ul>
                            <li>
            ...
            <div class="flex gap-5 lg-5 lg:mt-0">
                ...
                <div class="flex gap-2">
                    <ion-icon name="bag-handle-outline" class="p-2 rounded-full text-white bg-[#4F46E5]"></ion-icon>
                    <ion-icon name="person-outline" class="p-2 rounded-full text-white bg-[#059669]"></ion-icon>
                </div>
            </div>
        </div>
</nav>